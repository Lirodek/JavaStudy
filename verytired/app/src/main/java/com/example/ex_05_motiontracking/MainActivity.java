...
public class MainActivity extends AppCompatActivity {
    ...
    int color = 0;
    final float seekMax = 100.0f;
    final float seekMin = 1.0f;
    boolean mTouched = false;
    onClick onclick = new onClick();

    TextView my_textView;
    TextView seekStat;
    SeekBar lineCotroller;
    Button btn[] = new Button[5];
    int btnId[] = {R.id.btnRed, R.id.btnOrange, R.id.btnYellow, R.id.btnGreen, R.id.btnBlue};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lineCotroller = (SeekBar) findViewById(R.id.lineControl);
        mySurView = (GLSurfaceView) findViewById(R.id.glsurfaceview);
        my_textView = (TextView) findViewById(R.id.my_textView);
        seekStat = (TextView) findViewById(R.id.lineTxt);
        for(int i=0; i< btn.length; i++) {
            btn[i] = (Button) findViewById(btnId[i]);
            btn[i].setOnClickListener(onclick);
        }
            ...
            public void preRender() {
                ...
                if (mTouched) {
                    ...
                    for (HitResult hr : arr) {
                        ...
                        mRenderer.addPoint(pose.tx(), pose.ty(), pose.tz(), color, 20.0f);
                        //x축
        ...
        lineCotroller.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
    ...
    private void settingSeekBar(SeekBar lineCotroller) {
        int progress_half = (int)(((seekMax / seekMin) / 5)-1);

        ObjectAnimator animation = ObjectAnimator.ofInt(lineCotroller, "progress", progress_half);
